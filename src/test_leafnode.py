...
class TestTextNode(unittest.TestCase):
    def test_node_render(self):
        node = LeafNode("This is some text", "p", {"href": "https://www.google.com", "data-testid": "testing"})
    ...
    def test_empty_value_raises(self):
        nodes = [
            LeafNode(None, "p", {"href": "https://www.google.com", "data-testid": "testing"}),
    ...
    def test_no_tag_returns_raw_text(self):
        nodes = [
            LeafNode("This is some text", None, {"href": "https://www.google.com", "data-testid": "testing"}),
